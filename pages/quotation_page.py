...
class QuotationPage(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        ctk.CTkButton(
            ...
            fg_color="transparent", hover_color="#6B5B45",
            font=ctk.CTkFont(size=14, weight="bold"),
            command=self._preview_quotation, corner_radius=8,
 ...
 text_color="#000000",).pack(side="left", padx=4)
        ...
        ctk.CTkButton(
            ...
            font=ctk.CTkFont(size=14, weight="bold"),
            command=self._export_quotation, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="left", padx=4)
        ...
        ctk.CTkButton(
            ...
            command=self._open_supplier_config, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="left", padx=4)
        ...
        ctk.CTkButton(
            ...
            fg_color="transparent", hover_color="#4B5563",
            font=ctk.CTkFont(size=14),
            command=self._open_config, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="left", padx=4)
 ...
 text_color="#000000",).pack(side="left", padx=4)
        ...
        ctk.CTkButton(
            ...
            command=lambda: self._on_search(None), corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="left", padx=(0, 10), pady=12)

        self.confirm_btn = ctk.CTkButton(
            sb, text="确认", width=80, height=30,
            fg_color="transparent", hover_color="#7A9A6E",
            font=ctk.CTkFont(size=13, weight="bold"),
            command=self._on_confirm_supplier, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",)
        ...
        ctk.CTkButton(
            ...
            fg_color="transparent", hover_color="#4B5563",
            font=ctk.CTkFont(size=13, weight="bold"),
            command=self._on_reset_all, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="left", padx=(0, 10), pady=12)
        ...
        ctk.CTkButton(
            ...
            fg_color="transparent", hover_color="#6B5B45",
            font=ctk.CTkFont(size=13, weight="bold"),
            command=self._open_supplier_manage, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="left", padx=(0, 10), pady=12)
    ...
    def _open_supplier_manage(self):
        ...
        try:
            ...
            scroll_frame = ctk.CTkScrollableFrame(dlg, fg_color=self.C["card"], corner_radius=8, border_width=1, border_color="#8B7D6B")
    ...
    def _refresh_supplier_manage_list(self):
        ...
        for i, s in enumerate(suppliers):
            ...
            del_btn = ctk.CTkButton(
                ...
                fg_color="transparent", hover_color="#9A5555",
                font=ctk.CTkFont(size=13),
                command=make_delete(), corner_radius=8,
                border_width=1, border_color="#8B7D6B",
 text_color="#000000",)
            ...
            edit_btn = ctk.CTkButton(
                ...
                font=ctk.CTkFont(size=13),
                command=make_edit(), corner_radius=8,
                border_width=1, border_color="#8B7D6B",
 text_color="#000000",)
    ...
    def _open_supplier_edit(self, sid, data):
        ...
        ctk.CTkButton(
            ...
            fg_color="transparent", hover_color=self.C["primary_hover"],
            font=ctk.CTkFont(size=14, weight="bold"),
            command=_save, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="right", padx=8)

        ctk.CTkButton(
            btn_frame, text="取消", width=80, height=36,
            fg_color="transparent", hover_color="#6B7280",
            font=ctk.CTkFont(size=14),
            command=edit_dlg.destroy, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="right", padx=8)
    ...
    def _preview_quotation(self):
        ...
        ctk.CTkButton(btn_row, text="关闭", width=80, height=32,
                       font=ctk.CTkFont(family="Microsoft YaHei", size=13),
                       fg_color="transparent", hover_color="#4B5563",
                       command=preview_win.destroy, corner_radius=8, border_width=1, border_color="#8B7D6B", text_color="#000000",).pack(side="right")
        ctk.CTkButton(btn_row, text="导出 Excel", width=100, height=32,
                       font=ctk.CTkFont(family="Microsoft YaHei", size=13),
                       fg_color="transparent", hover_color="#7A9A6E",
                       command=lambda: [preview_win.destroy(), self._export_quotation()], corner_radius=8, border_width=1, border_color="#8B7D6B", text_color="#000000",).pack(side="right", padx=(0, 8))
...
class QuotationForm(ctk.CTkToplevel):
    ...
    def _build_ui(self):
        ...
        ctk.CTkButton(
            ...
            fg_color="transparent", hover_color=self.C["primary_hover"],
            font=ctk.CTkFont(size=13), command=self._add_tier_row, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 ...
 text_color="#000000",).pack(side="right", padx=8)
        ...
        ctk.CTkButton(
            ...
            fg_color="transparent", hover_color="#6B7280",
            font=ctk.CTkFont(size=14), command=self.destroy, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="right", padx=8)
    ...
    def _add_tier_row(self, data=None):
        ...
        del_btn = ctk.CTkButton(row, text="✕", width=40, height=30,
                                fg_color="transparent", hover_color="#9A5555",
                                font=ctk.CTkFont(size=13), command=_remove, corner_radius=8, border_width=1, border_color="#8B7D6B")
