...
class ThirdPartyPage(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        ctk.CTkButton(
            ...
            command=self._export_excel, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="left", padx=4, pady=5)
        ...
        self.stats_label.pack(side="left", padx=(12, 0), pady=5)
        ...
        ctk.CTkButton(
            ...
            command=self._add_qp_row, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="left")
        ...
        ctk.CTkButton(
            ...
            font=ctk.CTkFont(size=14),
            command=self._clear_form, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="right", padx=(8, 0))
        ...
        self.save_btn = ctk.CTkButton(
            ...
            font=ctk.CTkFont(size=14, weight="bold"),
            command=self._confirm_record, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",)
        ...
        z1 = ctk.CTkFrame(self.outer_scroll, fg_color="transparent", corner_radius=16)
        z1.pack(fill="both", expand=True, padx=24, pady=(0, 16))

        z2 = ctk.CTkFrame(z1, fg_color="transparent", corner_radius=8, border_width=1, border_color="#8B7D6B")
    ...
    def _add_qp_row(self):
        ...
        del_btn = ctk.CTkButton(
            ...
            command=lambda rf=row_frame: self._remove_qp_row(rf), corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",)
