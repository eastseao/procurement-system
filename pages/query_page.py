...
class QueryPage(ctk.CTkFrame):
 ...
 text_color="#000000",).pack(side="left", padx=4)
        ...
        ctk.CTkButton(
            ...
            fg_color="transparent", hover_color=self.C["primary_hover"],
            font=ctk.CTkFont(family="Microsoft YaHei", size=14, weight="bold"),
            command=self._apply_filter, corner_radius=8,
            border_width=1, border_color="#8B7D6B",
 text_color="#000000",).pack(side="left", padx=(0, 6))
        ...
        ctk.CTkButton(row1, text="重置", width=66, height=34,
                      ...
                      font=ctk.CTkFont(family="Microsoft YaHei", size=14),
                      command=self._reset_filter, corner_radius=8, text_color="#000000",).pack(side="left")
