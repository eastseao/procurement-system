...
class TravelPage(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        for cid, label, width in cols:
            ...
            self.tree.column(cid, width=width, minwidth=40,
...
class TravelForm(ctk.CTkToplevel):
    ...
    def _build(self):
        ...
        t_header = ctk.CTkFrame(card, fg_color="#F8FAFC", corner_radius=6)
        ...
        h_header = ctk.CTkFrame(card, fg_color="#F8FAFC", corner_radius=6)
