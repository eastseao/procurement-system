...
class PurchasePage(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        ctk.CTkButton(
            btn_frame, text="新增垫付", width=100, height=34,
...
class PurchaseForm(ctk.CTkToplevel):
    ...
    def _build(self):
        ...
        ctk.CTkButton(row0, text="＋项目", width=60, height=28,
                      ...
                      command=self._add_project, corner_radius=8, border_width=1, border_color="#8B7D6B", text_color="#000000",).grid(row=1, column=2, padx=4)
        ...
        items_header = ctk.CTkFrame(card, fg_color="transparent", corner_radius=6)
        ...
        ctk.CTkButton(card, text="＋ 添加物料行", height=30, width=120,
                      fg_color="transparent",
                      hover_color="#CBD5E1", font=ctk.CTkFont(size=13),
                      command=self._add_item_row, corner_radius=8, border_width=1, border_color="#8B7D6B", text_color="#000000",).pack(anchor="w", padx=16, pady=4)
    ...
    def _add_item_row(self, data=None):
        ...
        del_btn = ctk.CTkButton(row, text="✕", width=32, height=28,
                                 ...
                                 command=lambda r=row: self._remove_item_row(r), corner_radius=8, border_width=1, border_color="#8B7D6B")
