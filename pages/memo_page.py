...
class MemoPage(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        # ── 搜索栏 ─────────────────────────────────────
        search_frame = ctk.CTkFrame(self, fg_color=self.C["card"], corner_radius=10, height=56)
        ...
        self.project_combo = ctk.CTkComboBox(
            ...
            width=120, height=32, font=ctk.CTkFont(family="Microsoft YaHei", size=12),
        )
        ...
        self.status_combo = ctk.CTkComboBox(
            ...
            width=100, height=32, font=ctk.CTkFont(family="Microsoft YaHei", size=12),
        )
        ...
        # ── 表格区域 ─────────────────────────────────────
        list_frame = ctk.CTkFrame(self, fg_color=self.C["card"], corner_radius=10)
...
class MemoForm(ctk.CTkToplevel):
    ...
    def _section(self, parent, title):
        ...
        ctk.CTkLabel(f, text=title, font=ctk.CTkFont(family="Microsoft YaHei", size=13, weight="bold"),
