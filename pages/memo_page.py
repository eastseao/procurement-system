...
class MemoPage(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        ctk.CTkButton(
            btn_frame, text="新增备忘", width=100, height=34,
 ...
 text_color="#000000",).pack(side="left", padx=4)
        ...
        ctk.CTkButton(
            ...
            fg_color="transparent", hover_color="#7A9470",
            font=ctk.CTkFont(family="Microsoft YaHei", size=14, weight="bold"),
...
class MemoForm(ctk.CTkToplevel):
    ...
    def _build(self):
        ...
        card = ctk.CTkFrame(outer, fg_color=self.C["card"], corner_radius=8, border_width=1, border_color="#8B7D6B")
        ...
        ctk.CTkButton(btn_row, text="✕ 关闭", width=80, height=38,
                      fg_color="transparent", hover_color="#8B7B68",
                      font=ctk.CTkFont(family="Microsoft YaHei", size=14),
                      command=self.destroy, corner_radius=8, border_width=1, border_color="#8B7D6B", text_color="#000000",).pack(side="left", padx=4)
