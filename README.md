...
**采购助手**是由北京同仁堂健康药业（青海）有限公司采购部一线从业者 **EastSeaO** 利用业余时间独立开发的桌面端管理系统。作为日常采购工作的数字化工具，它覆盖了从物料下单、报价比价、合同生成到垫付报销、催款台账等核心业务环节，用代码解决重复劳动，用数据提升采购效率。
...
**EastSeaO** — 目前就职于北京同仁堂健康药业（青海）有限公司，在采购部从事包装采购业务。
